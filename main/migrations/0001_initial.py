# Generated by Django 4.2.6 on 2024-04-11 12:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amenities', models.ManyToManyField(to='main.listinghouseamenities')),
                ('image', models.ManyToManyField(to='main.image')),
                ('listing_house_area', models.ManyToManyField(to='main.listinghousearea')),
                ('listing_space_overview', models.ManyToManyField(to='main.listingspaceoverview')),
                ('location', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.location')),
                ('rental_condtion', models.ManyToManyField(to='main.rentalconditions')),
                ('rules_and_preferences', models.ManyToManyField(to='main.rulesandpreferences')),
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.profile')),
            ],
        ),
        migrations.CreateModel(
