...
from .views import main_view,about_view,detail_list_view,owner_view,dashboard_view,single_house_view,master_view,owner_second_view,upload,identity_page
from .views import multistepformsubmission,multistepsubmissionEdit,bookings_made,delete_upload,reject_tenant_request,approve_tenant_request,payement,map_view,messages_view,booking_requests,edit_listing_view,search,owner_listings,review_view,rate_image,my_view,create_booking,booking_confirmation_view
